      ...
      <View style={{padding: 20}}>
        ...
        <View style={styles.section}>
          <View style={styles.row}>
            ...
            <Text style={styles.sectionText}>
              {spotTypeConnectivity || Strings.NA}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          <View style={styles.row}>
            ...
            <Text style={styles.statusText}>
              {weightStable ? Strings.STABLE : Strings.NOT_STABLE}
            </Text>
        ...
        <View style={styles.section}>
          <View style={styles.row}>
            ...
            <Text style={styles.sectionText}>
              {delayed ? Strings.YES : Strings.NO}
            </Text>
          </View>
        </View>
        ...
        <Card style={{padding: 10, backgroundColor: colors.white}}>
          ...
          {readers.map((reader: any, index: number) => (
            <View key={index} style={styles.readerContainer}>
              ...
              <MaterialIcons
                name={
                  reader.healthStatus === Strings.OUT_OF_SERVICE
              ...
              <View>
                <Text style={styles.readerText}>
                  {Strings.DEVICE_ID}: {reader.deviceId}
                </Text>
                <Text style={styles.readerText}>
                  {Strings.HEALTH_STATUS}: {reader.healthStatus}
                </Text>
              </View>
            </View>
          ))}
