...
type CustomSwitchProps = {
    ...
    lable: string; // Text label to display next to the switch
    onChangeValue: (value: boolean) => void; // Callback function triggered on switch toggle
};

const SwitchWithLabel: React.FC<CustomSwitchProps> = memo(({ value, lable, onChangeValue }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity style={[styles.switchContainer, containerStyle]} onPress={handleToggle} activeOpacity={0.8}>
