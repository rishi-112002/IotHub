...
function WeighBridgeFunction(props: { id: any }) {
  ...
  const handleUploadData = () => {
    ...
    if (!platformReadyTicks) {
      console.log("platform ready Ticks")
      newErrors.platformReadyTicks = 'Platform Ready Ticks is required';
    }
    if (!minVehicleWeight) {
      console.log("minVehicleWeight", minVehicleWeight)
    ...
    if (!minTagCount) {
      newErrors.minTagCount = 'min tagcount is required';
    }
    ...
    if (
      platformMinWeight !== undefined &&
      platformMinWeight !== null &&
      platformMinWeight !== "" &&
      platformMaxWeight !== undefined &&
      platformMaxWeight !== null &&
      platformMaxWeight !== "" &&
      platformMinWeight >= platformMaxWeight
    ) {
      newErrors.platformMinWeight = "Platform min weight is always less than Platform Max weight";
    }
    if (
      minVehicleWeight !== undefined &&
      minVehicleWeight !== "" &&
      minVehicleWeight !== null &&
      platformMaxWeight !== undefined &&
      platformMaxWeight !== null &&
      ...
      newErrors.minVehicleWeight = "min vehicle weight is always more than Platform Max weight";
    }
